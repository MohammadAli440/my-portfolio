            ...
            <div className="services__modal-content">
              ...
              <ul className="services__modal-services grid">
                <li className="services__modal-service">
                  ...
                  <p className="services__modal-info">Ecommerce development.</p>
                </li>
          ...
          >
            <div className="services__modal-content">
              ...
              <ul className="services__modal-services grid">
                ...
                <li className="services__modal-service">
                  <i className="uil uil-check-circle services__modal-icon"></i>
                  <p className="services__modal-info">Social Media Graphics.</p>
                </li>

                <li className="services__modal-service">
                  <i className="uil uil-check-circle services__modal-icon"></i>
                  <p className="services__modal-info">Infographic Design.</p>
                </li>
          ...
          >
            <div className="services__modal-content">
              ...
              <ul className="services__modal-services grid">
                ...
                <li className="services__modal-service">
                  <i className="uil uil-check-circle services__modal-icon"></i>
                  <p className="services__modal-info">Visual Design System.</p>
                </li>
